...
def GuessTheNumber(computer_generated, guess, low, high):   
    count = 0
    while(guess):
...
result = GuessTheNumber(computer_generated, guess, low, high)
...
if result:
    ...
    if result == 4:
        ...
        print('Computer generated Number : ', guess)
